...
function clickHandler(){
  ...
  //alert("check2");
  //chrome.cookies.set({"url":"http://www.anticiclick/test.com","name":"test"});
  //chrome.cookies.set({"url":"http://www.anticiclickx.com","name":"QV_X","value":QV_X.join()});
  //chrome.cookies.set({"url":"http://www.anticiclicky.com","name":"QV_Y","value":QV_Y.join()});
  //chrome.cookies.set({"url":"http://www.anticiclickrec.com","name":"RECORD","value":[this.num, res].join()});
  //alert(this.num+" "+res);
  //alert(vote_list);
  //prefetch(this.href);
}
...
//  alert("check1");
//  chrome.cookies.get({"url":"http://www.anticiclick.com/x", "name":"QV_X"}, function(cookie){
//    alert(cookie.value);
//  });
//  alert("check2");
}
